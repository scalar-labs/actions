...
The complete workflow configuration is available in [`.github/workflows/auto-translate-docs-reusable.yml`](/.github/workflows/auto-translate-docs-reusable.yml).
...
If necessary, you can edit `direct_prompt` in `auto-translate-docs-reusable.yml` to change translation behavior:
