...
public class ReleaseNoteCreationTest {
    ...
    @ParameterizedTest
    @MethodSource
    void extracReleaseNoteInfo_normalText_addedCorrectCategory(ReleaseNoteCreation.Category category, String rnText) throws Exception {
        // Arrange
        ...
        // Assert
        Map<ReleaseNoteCreation.Category, List<ReleaseNoteCreation.ReleaseNoteText>> categoryMap = sut.categoryMap;
    ...
    @ParameterizedTest
    @EnumSource
    void extracReleaseNoteInfo_notAvailable_shouldBeIgnored(ReleaseNoteCreation.Category category) throws Exception {
        // Arrange
        ReleaseNoteCreation sut = new ReleaseNoteCreation(mockedGhContext(category, "NA"));
    ...
    @ParameterizedTest
    @EnumSource
    void extracReleaseNoteInfo_textIsEmpty_releaseNoteTextIsAStringAsNULL(ReleaseNoteCreation.Category category) throws Exception {
        // Arrange
    ...
    @Test
    void assortSameAsItems_multiplePullRequestsAreTheSameFeature_managedInSameAsItems() throws Exception {
        // Arrange
        ReleaseNoteCreation.GitHubContext ghContextMock = mock(ReleaseNoteCreation.GitHubContext.class);
        addMockBehaviourToGitHubContext(ghContextMock, "1", ReleaseNoteCreation.Category.ENHANCEMENT, "A topic pull request.");
        addMockBehaviourToGitHubContext(ghContextMock, "2", ReleaseNoteCreation.Category.ENHANCEMENT, "Same as #1");
        addMockBehaviourToGitHubContext(ghContextMock, "3", ReleaseNoteCreation.Category.IMPROVEMENT, "Additional comment 1.\nSame as #1");
        addMockBehaviourToGitHubContext(ghContextMock, "4", ReleaseNoteCreation.Category.BUGFIX, "Same as #1\nAdditional comment 2.");
        ...
        assertThat(releaseNoteText.text).isEqualTo("A topic pull request. Additional comment 1. Additional comment 2.");
    }

    @Test
    void extracReleaseNoteInfo_withoutCategory_addedToMiscellaneousCategory() throws Exception {
        // Arrange
        ...
        when(ghContextMock.runSubProcessAndGetOutputAsReader(endsWith("--json labels"))).thenReturn(null);
        ReleaseNoteCreation sut = new ReleaseNoteCreation(ghContextMock);
        ...
        // Assert
        Map<ReleaseNoteCreation.Category, List<ReleaseNoteCreation.ReleaseNoteText>> categoryMap = sut.categoryMap;
        List<ReleaseNoteCreation.ReleaseNoteText> releaseNoteTexts = categoryMap.get(ReleaseNoteCreation.Category.MISCELLANEOUS);
        assertThat(releaseNoteTexts).isNotNull();
        assertThat(releaseNoteTexts.size()).isEqualTo(1);
    ...
    @Test
    void outputReleaseNote_normalReleaseNoteTexts_outputVlidReleaseNote() throws Exception {
        // Arrange
        ReleaseNoteCreation.GitHubContext ghContextMock = mock(ReleaseNoteCreation.GitHubContext.class);
        addMockBehaviourToGitHubContext(ghContextMock, "1", ReleaseNoteCreation.Category.ENHANCEMENT, "A topic pull request.");
        addMockBehaviourToGitHubContext(ghContextMock, "2", ReleaseNoteCreation.Category.ENHANCEMENT, "Same as #1");
        addMockBehaviourToGitHubContext(ghContextMock, "3", ReleaseNoteCreation.Category.IMPROVEMENT, "Additional comment 1.\nSame as #1");
        addMockBehaviourToGitHubContext(ghContextMock, "4", ReleaseNoteCreation.Category.BUGFIX, "Same as #1\nAdditional comment 2.");
        addMockBehaviourToGitHubContext(ghContextMock, "5", ReleaseNoteCreation.Category.IMPROVEMENT, "An improvement text");
        addMockBehaviourToGitHubContext(ghContextMock, "6", ReleaseNoteCreation.Category.BUGFIX, "A bugfix text");
        addMockBehaviourToGitHubContext(ghContextMock, "7", ReleaseNoteCreation.Category.DOCUMENTATION, "A documentation text");
    ...
    static Stream<Arguments> extracReleaseNoteInfo_normalText_addedCorrectCategory() {
        return Stream.of(
            ...
            arguments(ReleaseNoteCreation.Category.DOCUMENTATION, "a release note text in documentation"),
            arguments(ReleaseNoteCreation.Category.MISCELLANEOUS, "a release note text in miscellaneous")
        );
    }

    ReleaseNoteCreation.GitHubContext mockedGhContext(ReleaseNoteCreation.Category category, String rnText) throws Exception {
        ReleaseNoteCreation.GitHubContext ghContextMock = mock(ReleaseNoteCreation.GitHubContext.class);
        when(ghContextMock.isPullRequestMerged(anyString())).thenReturn(true);
    ...
    void addMockBehaviourToGitHubContext(ReleaseNoteCreation.GitHubContext mock, String prNumber, ReleaseNoteCreation.Category category, String rnText) throws Exception {
    ...
    BufferedReader normalPullRequestBody(String text) throws Exception {
        StringBuilder builder = new StringBuilder();
        builder
            .append("## Dummy section\n")
